...
function AppServer() {
  ...
  this.server.post('/address/v1', basicAuth.isAuthenticated, addressHandler.createAddress);
  this.server.get('/address/v1', basicAuth.isAuthenticated, addressHandler.getAllAddress);
  this.server.get('/address/v1/:addressId', basicAuth.isAuthenticated, addressHandler.getAddress);
  this.server.put('/address/v1/update/:addressId', basicAuth.isAuthenticated, addressHandler.updateAddress);
  this.server.del('/address/v1/:addressId', basicAuth.isAuthenticated, addressHandler.deleteAddress);
