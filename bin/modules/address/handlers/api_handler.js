...
const getAllAddress = async (req, res) => {
  const postRequest = async () => {
    return queryHandler.getAllAddress();
  };

  const sendResponse = async (result) => {
    (result.err) ? wrapper.response(res, 'fail', result, 'Get all address fail')
      : wrapper.response(res, 'success', result, 'Get all address success', http.OK);
  };
...
const createAddress = async (req, res) => {
  ...
  const sendResponse = async (result) => {
    (result.err) ? wrapper.response(res, 'fail', result, 'Create address fail')
      : wrapper.response(res, 'succes', result, 'Create address success', http.OK);
  };
  sendResponse(await postRequest(validatePayload));
};
...
const updateAddress = async (req, res) => {
  ...
  const sendResponse = async (result) => {
    (result.err) ? wrapper.response(res, 'fail', result, 'update address fail')
      : wrapper.response(res, 'success', result, 'update address success');
  };
  sendResponse(await postRequest(validatePayload));
};
...
const deleteAddress = async (req, res) => {
  ...
  const sendResponse = async (result) => {
    (result.err) ? wrapper.response(res, 'fail', result, 'delete address fail')
      : wrapper.response(res, 'success', result, 'delete address success');
  };
  sendResponse(await postRequest(validatePayload));
};
